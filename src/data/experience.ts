...
export const workExperiences: WorkExperience[] = [
  {
    ...
    description: [
      "Increased website responsiveness and reliability through performance tuning and system optimization.",
"Engineered internal tools that automated key business workflows and improved operational productivity.",
"Delivered scalable software solutions by collaborating with engineering and business teams throughout the development lifecycle.",
    ],
    skills: [
